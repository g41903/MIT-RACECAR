...
if("TRUE" STREQUAL "TRUE")
  set(ackermann_cmd_mux_SOURCE_PREFIX /home/racecar/team-ws/src/racecar/ackermann_cmd_mux)
  set(ackermann_cmd_mux_DEVEL_PREFIX /home/racecar/team-ws/devel)
  ...
  set(ackermann_cmd_mux_INSTALL_PREFIX /home/racecar/team-ws/install)
...
if(NOT "/home/racecar/team-ws/devel/include;/home/racecar/team-ws/src/racecar/ackermann_cmd_mux/include " STREQUAL " ")
  set(ackermann_cmd_mux_INCLUDE_DIRS "")
  set(_include_dirs "/home/racecar/team-ws/devel/include;/home/racecar/team-ws/src/racecar/ackermann_cmd_mux/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ackermann_cmd_mux' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/racecar/team-ws/src/racecar/ackermann_cmd_mux/${idir}'.  Ask the maintainer 'Michael Boulet <boulet@ll.mit.edu>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${ackermann_cmd_mux_dep}_FOUND)
      find_package(${ackermann_cmd_mux_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ackermann_cmd_mux_dep} REQUIRED ${depend_list})
  endif()
